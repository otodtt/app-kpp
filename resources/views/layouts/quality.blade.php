        ...
        <ul class="nav navbar-nav">
            ...
            <li>
                ...
                <ul class="dropdown-menu" >
                    <li><a href="{!! URL::to( '/контрол/сертификати-внос') !!}" class="my_a back_link"> <i class="fa fa-certificate fa-fw yellow"></i> Издадени сертификати</a></li>
                    ...
                    <li><a href="{!! URL::to('/контрол/култури/внос')!!}" class="my_a back_link"> <i class="fa fa-leaf fa-fw green_color"></i> Култури</a></li>
