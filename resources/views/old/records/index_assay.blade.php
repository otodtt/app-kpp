...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">ВСИЧКИ КОНСТАТИВНИ ПРОТОКОЛИ С ВЗЕТИ ПРОБИ</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <span class="fa fa-flask btn btn-default my_btn"> С взети проби</span>
    </div>
    <hr/>
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    {!! Form::open(array('url'=>'/протоколи-проби', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/протоколи-проби/сортирай', 'method'=>'POST')) !!}
                @include('old.records.index_assay.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/протоколи-проби/сортирай', 'method'=>'POST')) !!}
                @include('old.records.index_assay.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.records.index_assay.alphabet')
    <div class="refresh">
        <a href="{{ url('/протоколи-проби') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('old.records.index_assay.table')
@endsection
...
@section('scripts')
    ...
    {!!Html::script("js/records/assayTable.js" )!!}
