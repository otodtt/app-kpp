...
@section('title')
    {{ 'Констативни Протоколи Други плащания' }}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">КОНСТАТИВНИ ПРОТОКОЛИ ЗА ДРУГИ ПЛАЩАНИЯ</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    {!! Form::open(array('url'=>'/протоколи-други', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/протоколи-други/сортирай', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/протоколи-други/сортирай', 'method'=>'POST')) !!}
                @include('old.records.index_others.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.records.index_others.alphabet')
    <div class="refresh">
        <a href="{{ url('/протоколи-други') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
