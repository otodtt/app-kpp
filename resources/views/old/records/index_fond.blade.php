...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">КОНСТАТИВНИ ПРОТОКОЛИ ИЗДАДЕНИ ПРИ ПРОВЕРКИ С ДФЗ</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    {!! Form::open(array('url'=>'/протоколи-дфз', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/протоколи-дфз/сортирай', 'method'=>'POST')) !!}
                @include('old.records.index_fond.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/протоколи-дфз/сортирай', 'method'=>'POST')) !!}
                @include('old.records.index_fond.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.records.index_fond.alphabet')
    <div class="refresh">
        <a href="{{ url('/протоколи-дфз') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
