...
@section('title')
    {{ 'Стари - Констативни Протоколи за Становища' }}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title title-bottom">КОНСТАТИВНИ ПРОТОКОЛИ ЗА ИЗМИНАЛИ ГОДИНИ ЗА СТАНОВИЩА</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <span class="fa fa-address-card-o btn btn-default my_btn"> За Становища</span>
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    {!! Form::open(array('url'=>'/стари-протоколи-становища', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/стари-протоколи-становища/сортирай', 'method'=>'POST')) !!}
                @include('old.records_old.index_opinions.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/стари-протоколи-становища/сортирай', 'method'=>'POST')) !!}
                @include('old.records_old.index_opinions.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.records_old.index_opinions.alphabet')
    <div class="refresh">
        <a href="{{ url('/стари-протоколи-становища') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
