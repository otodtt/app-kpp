...
@section('title')
    {{ 'Стари - Констативни Протоколи Други плащания' }}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title title-bottom">КОНСТАТИВНИ ПРОТОКОЛИ ЗА ИЗМИНАЛИ ГОДИНИ ЗА ДРУГИ ПЛАЩАНИЯ</h4>
    </div>
    <hr/>
    <div class="btn-group">
        ...
        <span class="fa fa-euro btn btn-default my_btn"> Други плащания</span>
    </div>
    <hr/>
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    {!! Form::open(array('url'=>'/стари-протоколи-други', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/стари-протоколи-други/сортирай', 'method'=>'POST')) !!}
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/стари-протоколи-други/сортирай', 'method'=>'POST')) !!}
                @include('old.records_old.index_others.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.records_old.index_others.alphabet')
    <div class="refresh">
        <a href="{{ url('/стари-протоколи-други') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
