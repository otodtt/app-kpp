...
@section('content')
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-6">
                    ...
                    @include('old.opinions.old.index.search')
                    {!! Form::close() !!}
                </div>
                <div class="col-md-6">
                    <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                ...
                @include('old.opinions.old.index.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/становища-стари/сортирай', 'method'=>'POST')) !!}
                @include('old.opinions.old.index.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.opinions.old.index.alphabet')
    <div class="refresh">
        <a href="{{ url('/становища-стари') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('old.opinions.old.index.table')
@endsection
