...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 ">
                <h4 class="my_center bold">РЕДАКТИРАНЕ НА СТАНОВИЩЕ</h4>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::model($opinion, ['url'=>'редактирай/становище/'.$opinion->id.'/update' , 'method'=>'POST', 'id'=>'form']) !!}
            <hr class="my_hr"/>
            @include('old.opinions.new.forms.petition')
            <hr class="my_hr"/>
            @if(isset($opinion))
                    ...
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Данни на заявителя</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.opinions.new.forms.exist_data')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Адрес на Заявителя</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.opinions.new.forms.location')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Други данни</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.opinions.new.forms.phones')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Други за стопанството</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.opinions.new.forms.location_farm')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Данни за Констативния Протокол</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.opinions.new.forms.edit')
                            </div>
                        </fieldset>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <a href="{{ '/становище/'.$opinion->id }}" class="fa fa-arrow-circle-left btn btn-success my_btn-success"> Назад към Становището!</a>
            </div>
