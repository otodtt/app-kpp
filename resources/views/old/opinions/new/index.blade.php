...
@section('content')
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-5">
                    ...
                    @include('old.opinions.new.index.search')
                    {!! Form::close() !!}
                </div>
                <div class="col-md-4">
                    <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                ...
                @include('old.opinions.new.index.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/становища/сортирай', 'method'=>'POST')) !!}
                @include('old.opinions.new.index.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    <hr/>
    @include('old.opinions.new.index.alphabet')
    <div class="refresh">
        <a href="{{ url('/становища') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('old.opinions.new.index.table')
@endsection
