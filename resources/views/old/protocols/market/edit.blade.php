...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 ">
                ...
                @include('old.protocols.market.form_add.edit_info')
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        {!! Form::open(['url'=>'протоколи/'.$protocols->id.'/update', 'method'=>'POST', 'id'=>'form']) !!}
            <hr class="my_hr"/>
            @include('old.protocols.market.form_add.radio_type')
            <hr class="my_hr"/>

            @include('old.protocols.market.form_add.number_protocol')
            <hr class="my_hr"/>

            @include('old.protocols.market.form_add.inspectors')
            <hr class="my_hr"/>

            @include('old.protocols.market.form_add.data_protocol')
            <hr class="my_hr"/>

            @include('old.protocols.market.form_add.edit_example')
            <hr class="my_hr"/>
