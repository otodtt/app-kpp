...
@section('content')
    ...
    <div class="form-group">
        ...
        {!! Form::model($protocols, ['url'=>'обект-протокол/'.$protocols->id.'/update', 'method'=>'POST', 'id'=>'form']) !!}
            @include('old.protocols.none.forms.inspectors')
            <hr class="my_hr"/>
            @include('old.protocols.none.forms.data_object')
            <hr class="my_hr"/>
                    ...
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Точен адрес на Фирмата/Лицето</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.protocols.none.forms.locations')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Адрес на проверения обекр</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.protocols.none.forms.object_location')
                            </div>
                        </fieldset>
                    </div>
                </div>
            ...
            <hr class="my_hr"/>
            @include('old.protocols.none.forms.data_protocol')
            <hr class="my_hr"/>
            @include('old.protocols.none.forms.example_edit')
            <hr class="my_hr"/>
            <div class="col-md-6 ">
