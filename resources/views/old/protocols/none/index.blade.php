...
@section('title')
    {{ 'Констативни Протоколи Нерегламентирани обекти' }}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">КОНСТАТИВНИ ПРОТОКОЛИ НА НЕРЕГЛАМЕНТИРАНИ ОБЕКТИ</h4>
    </div>
    <hr/>
    <div class="btn-group my_group">
        ...
        <span class="fa fa-object-ungroup btn btn-default my_btn"> Протоколи Нерегламентирани Обекти</span>
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-12">
                    {!! Form::open(array('url'=>'/протоколи-обекти', 'method'=>'POST', 'id'=>'search_form')) !!}
                    @include('old.protocols.market.index.search')
                    {!! Form::close() !!}
                    <span class="right_span">
                        <a  href="{!! URL::to('обект-протокол/добави')!!}" class="fa fa-object-ungroup btn btn-danger my_btn "> Добави Протокол на нерегламентиран обект!</a>
                    </span>
                </div>
                <div class="col-md-6">
                    <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/протоколи-обекти/сортирай', 'method'=>'POST')) !!}
                @include('old.protocols.none.index.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/протоколи-обекти/сортирай', 'method'=>'POST')) !!}
                @include('old.protocols.none.index.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    ...
    @include('old.protocols.none.index.alphabet')
    <div class="refresh">
        <a href="{{ url('/протоколи-обекти') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('old.protocols.none.index.table')
@endsection
