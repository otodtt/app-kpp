...
@section('content')
    ...
    <div class="alert alert-danger my_alert" role="alert">
        <p class="my_p"><span class="fa fa-warning red" aria-hidden="true"></span> <span class="bold red">ВНИМАНИЕ! Прочети преди да продължиш!</span><br/>
            <span class="bold">Тук се добавят Констативни Протоколи само при проверки на обекти (аптеки, складове, цехове) в други области!</span>
        </p>
    </div>
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 ">
                <h4 class="my_center bold">ДОБАВЯНЕ НА КОНСТАТИВЕН ПРОТОКОЛ ЗА ПРОВЕРКА В ДРУГА ОБЛАСТ</h4>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::open(['url'=>'друг-обект/добави/store' , 'method'=>'POST', 'id'=>'form', 'files'=>true]) !!}
            <hr class="my_hr"/>
            @include('old.protocols.others.forms.inspectors')
            <hr class="my_hr"/>

            @include('old.protocols.others.forms.firm_data')
                    ...
                    <div class="col-md-12">
                        <fieldset class="small_field">
                            ...
                            <div class="col-md-12 col-md-6_my inspectors_divs ">
                                @include('old.protocols.others.forms.object_location')
                            </div>
                        </fieldset>
                    </div>
                </div>
            ...
            <hr class="my_hr"/>
            @include('old.protocols.others.forms.data_protocol')
            <hr class="my_hr"/>

            <div class="col-md-6 ">
                <a href="{{ '/други-обекти' }}" class="fa fa-arrow-circle-left btn btn-success my_btn-success">
