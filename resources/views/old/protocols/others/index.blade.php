...
@section('content')
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                ...
                @include('old.protocols.others.index.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/други-обекти/сортирай', 'method'=>'POST')) !!}
                @include('old.protocols.others.index.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
