...
@section('title')
    {{ 'Констативен Протокол в друга област' }}
@endsection

@section('css')
    {!!Html::style("css/documents/logo_document.css" )!!}
    {!!Html::style("css/protocols/show.css" )!!}
    {!!Html::style("css/protocols/show_others.css" )!!}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">ДАННИ ЗА КОНСТАТИВЕН ПРОТОКОЛ ПРИ ПРОВЕРКА В ДРУГА ОБЛАСТ</h4>
    </div>
    <hr/>
    <div class="btn-group">
    ...
    <span class="">
        <a href="{{ URL::to('/друг-обект/'.$protocol->id.'/редактирай') }}" class="fa fa-edit btn btn-danger my_btn">  Редактирай Протокола!</a>
    </span>
    <hr class="">
    ...
    <div id="wrap_in" class="col-md-12" style="padding-bottom: 50px">
        <div class="page"  >
            ...
            <div class="col-md-12" id="flip_in">
                ...
                @include('old.protocols.others.show.body_show')
