...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">КОНСТАТИВНИ ПРОТОКОЛИ НА ПРОИЗВОДИТЕЛИ НА ПРЗ</h4>
    </div>
    <hr/>
    <div class="btn-group my_group">
        ...
        <span class="fa fa-industry btn btn-default my_btn">  Протоколи Производители на ПРЗ</span>
    </div>
    <hr/>
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                <div id="search_wrap" class="col-md-12">
                    {!! Form::open(array('url'=>'/производители', 'method'=>'POST', 'id'=>'search_form')) !!}
                    @include('old.protocols.market.index.search')
                    {!! Form::close() !!}
                    <span class="right_span">
                        <a  href="{!! URL::to('производител/добави-протокол')!!}" class="fa fa-industry btn btn-danger my_btn "> Добави Протокол на производител на ПРЗ!</a>
                    </span>
                </div>
                <div class="col-md-6">
                    <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/производители/сортирай', 'method'=>'POST')) !!}
                @include('old.protocols.factories.index.years_sort')
                {!! Form::close() !!}
                <span class="errors">
    ...
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                {!! Form::open(array('url'=>'/производители/сортирай', 'method'=>'POST')) !!}
                @include('old.protocols.factories.index.sorting')
                {!! Form::close() !!}
            </div>
        </div>
    </fieldset>
    ...
    @include('old.protocols.factories.index.alphabet')
    <div class="refresh">
        <a href="{{ url('/производители') }}" class="fa fa-eraser btn btn-primary my_btn">&nbsp; Изчисти сортирането!</a>
    </div>
    <hr/>
    @include('old.protocols.factories.index.table')
@endsection
