...
@section('title')
    {{ 'Констативен Протокол Производител на ПРЗ' }}
@endsection

@section('css')
    {!!Html::style("css/documents/logo_document.css" )!!}
    {!!Html::style("css/protocols/show.css" )!!}
    {!!Html::style("css/protocols/show_factory.css" )!!}
@endsection
...
@section('content')
    <div class="div-layout-title">
        <h4 class="bold layout-title">ДАННИ ЗА КОНСТАТИВЕН ПРОТОКОЛ НА ПРОИЗВОДИТЕЛ НА ПРЗ</h4>
    </div>
    <hr/>
    <div class="btn-group">
    ...
    <span class="">
        <a href="{{ URL::to('/производител/'.$protocol->id.'/редактирай') }}" class="fa fa-edit btn btn-danger my_btn">  Редактирай Протокола!</a>
    </span>
    <hr class="">
    ...
    <div id="wrap_in" class="col-md-12" style="padding-bottom: 50px">
        <div class="page"  >
            ...
            <div class="col-md-12" id="flip_in">
                ...
                @include('old.protocols.factories.show.body_show')
