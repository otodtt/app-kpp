...
@section('content')
    ...
    <div class="form-group">
        ...
        {!! Form::model($protocol, ['url'=>'производител/'.$protocol->id.'/update', 'method'=>'POST', 'id'=>'form']) !!}
            @include('old.protocols.factories.forms.inspectors')
            <hr class="my_hr"/>

            @include('old.protocols.factories.forms.select_firm')
            <hr class="my_hr"/>
                    ...
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Данни на Фирмата</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.protocols.factories.forms.firm_data')
                            </div>
                        </fieldset>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Адрес на проверения обекр</legend>
                            <div class="col-md-12 col-md-6_my inspectors_divs " >
                                @include('old.protocols.factories.forms.object_location')
                            </div>
                        </fieldset>
                    </div>
                </div>
            ...
            <hr class="my_hr"/>
            @include('old.protocols.factories.forms.data_protocol')
            <hr class="my_hr"/>

            @include('old.protocols.factories.forms.example_edit')
            <hr class="my_hr"/>
