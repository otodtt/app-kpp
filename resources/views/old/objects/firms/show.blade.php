    ...
    <fieldset class="big_field">
        ...
        <div class="row-height-my" style="display: table">
            <div class="small_field_left" style="display: table-cell">
                @include('old.objects.forms.firm_info_all')
            </div>
        ...
        <ul class="nav" id="side-menu">
            <li class="li_pharmacy">
                ...
                @else
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            @include('old.objects.firms.body.pharmacies')
                        </li>
                    </ul>
                @endif
            </li>
            <li class="li_repository">
                ...
                @else
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            @include('old.objects.firms.body.repositories')
                        </li>
                    </ul>
                @endif
            </li>
            <li class="li_workshop">
                ...
                @else
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            @include('old.objects.firms.body.workshops')
                        </li>
                    </ul>
                @endif
            </li>
