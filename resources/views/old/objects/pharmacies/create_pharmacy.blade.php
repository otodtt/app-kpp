...
@section('title')
    {{ 'Добави Удостоверение за Аптека!' }}
@endsection
...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 " >
                <a href="{!! '/аптеки' !!}" class="fa fa-plus-square btn btn-info my_btn"> Към всички Аптеки</a>
                <h3 class="my_center" >Добавяне на Аптека и Удостоверение!</h3>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::open(['route'=>'pharmacies.store', 'method'=>'POST', 'id'=>'form']) !!}
            @include('old.objects.forms.form_create_pharmacy')
            <div class="col-md-6 " >
                <a href="/фирма/{{$firm->id}}" class="fa fa-arrow-circle-left btn btn-success my_btn-success"> Откажи! Назад към фирмата!</a>
            </div>
            <div class="col-md-6" >
                {!! Form::submit('Добави НОВА Аптека!', ['class'=>'btn btn-danger', 'id'=>'submit']) !!}
            </div>
