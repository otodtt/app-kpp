...
<hr class="my_hr"/>
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 " >
                ...
                <h3 class="my_center" >Добавяне на Аптека и Разрешително!</h3>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        {!! Form::open(['url'=>'pharmacies/permit-store/'.$firm->id , 'method'=>'POST', 'id'=>'form']) !!}
            @include('old.objects.forms.form_create_permit')
            <div class="col-md-6 " >
