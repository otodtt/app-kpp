...
@section('content')
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 " >
                <a href="/фирма/{{$workshop->firm_id}}" class="fa fa-arrow-left btn btn-success "> Назад!</a>
                <h3 class="my_center">Промяна в обстоятелствата на Цех!</h3>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        @endif
        {!! Form::model($workshop, ['url'=>'workshops/change-workshop-add/'.$workshop->id , 'method'=>'POST', 'id'=>'form']) !!}
        @include('old.objects.change.forms.form_change_workshop')
