...
@section('content')
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-1">
                <a href="/склад-удостоверение/{{$repository->firm_id}}/{{$repository->id}}/{{$repository->edition}}/" class="fa fa-arrow-left btn btn-success "> Назад!</a>
            </div>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::model($repository, ['url'=>'update-repository-edition/'.$repository->firm_id.'/'.$repository->id , 'method'=>'POST', 'id'=>'form']) !!}
        @include('old.objects.documents_all.edit_documents.forms.form_edit_repository_edition')
