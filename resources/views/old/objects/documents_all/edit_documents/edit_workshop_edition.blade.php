...
@section('content')
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-1">
                <a href="/цех-удостоверение/{{$workshop->firm_id}}/{{$workshop->id}}/{{$workshop->edition}}/" class="fa fa-arrow-left btn btn-success "> Назад!</a>
            </div>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::model($workshop, ['url'=>'update-workshop-edition/'.$workshop->firm_id.'/'.$workshop->id , 'method'=>'POST', 'id'=>'form']) !!}
        @include('old.objects.documents_all.edit_documents.forms.form_edit_workshop_edition')
