...
@section('title')
    {{ 'Дневник за взетите проби от ПРЗ' }}
@endsection
...
@section('content')
    ...
    <div class="btn-group">
        ...
        <span class="fa fa-flask btn btn-default my_btn"> Дневник проби от ПРЗ</span>
        <a href="{!! URL::to('/проби-тор')!!}" class="fa fa-leaf btn btn-info my_btn"> Дневник проби от ТОРОВЕ</a>
    </div>
    <hr/>
    <div class="div-layout-title">
        <h4 class="bold layout-title title">ДНЕВНИК ЗА ВЗЕТИТЕ И ИЗПРАТЕНИ ПРОБИ ОТ ПРОДУКТИ ЗА РАСТИТЕЛНА ЗАЩИТА</h4>
    </div>
    <fieldset class="form-group">
        <div class="wrap_sort">
            <div id="wr_choiz_all" class="col-md-12">
                {!! Form::open(array('url'=>'/проби', 'method'=>'POST')) !!}
    ...
    @include('old.samples.market.index.table')
@endsection
