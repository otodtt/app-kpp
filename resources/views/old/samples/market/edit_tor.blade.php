...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert">
        <div class="row">
            <div class="col-md-12 ">
                ...
                ?>
                <h4 class="my_center bold">РЕДАКТИРАНЕ И ДОБАВЯНЕ НА ДАННИ ЗА ВЗЕТА ПРОБА ОТ ТОР ОТ:<br>
    ...
    <div class="form-group">
        ...
        @endif
        {!! Form::open(['url'=>'проба-тор/update/'.$samples->id, 'method'=>'POST', 'id'=>'form']) !!}
        <hr class="my_hr"/>

        @include('old.samples.market.edit.number')
        <hr class="my_hr"/>

        @include('old.samples.market.edit.data_tor')
        <hr class="my_hr"/>

        <div class="col-md-6 ">
            <a href="{{ '/проби-тор' }}" class="fa fa-arrow-circle-left btn btn-success my_btn-success">
