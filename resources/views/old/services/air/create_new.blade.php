                ...
                <div class="row">
                    <div class="col-md-12" >
                        <fieldset class="small_field"><legend class="small_legend">Данни за Стопанството</legend>
                            @include('old.services.air.new.location_farm')
                        </fieldset>
                    </div>
                </div>
            </div>
            <hr class="my_hr"/>
            @include('old.services.air.add.permit')
            <hr class="my_hr"/>

            @include('old.services.air.add.numbers')
            <hr class="my_hr"/>

            @include('old.services.air.add.data_permit')
            <hr class="my_hr"/>

            @include('old.services.air.add.pests')
            <hr class="my_hr"/>

            @include('old.services.air.add.certificate')
            <hr class="my_hr"/>
