...
@section('content')
    <h4 class=" title_doc" >РАЗРЕШИТЕЛНИ ЗА ВЪЗДУШНО ТРЕТИРАНЕ</h4>
    <hr class="my_hr"/>
    @if(count($errors)>0)
        ...
        <div class="wrap_sort">
            <div id="wr_choiz_all">
                ...
                <div id="search_wrap" class="col-md-5">
                    ...
                    @include('old.services.air.index.sorting')
                </div>
    ...
    <hr class="my_hr"/>
        @include('old.services.air.index.alphabet')
    ...
    <br/>
    <hr class="my_hr"/>
    @include('old.services.air.index.table')
@endsection
