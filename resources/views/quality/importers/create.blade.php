...
@section('content')
    ...
    <div class="alert alert-info my_alert" role="alert" style="text-align: center">
        <p class="my_p"><span class="fa fa-warning red" aria-hidden="true"></span> <span class="bold red">Внимание! Прочети преди да продължиш!</span><br/>
            <span class="bold red">Тук се добавят само нови фирми вносителки или ако ги няма в падащото меню!</span><br/>
            <span class="bold red">Важо е да се отбележи дали фирмата е българска или не!</span><br/>
        </p>
    </div>
